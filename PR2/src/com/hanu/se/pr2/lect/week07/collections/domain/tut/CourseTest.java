...
public class CourseTest {
	...
	public static void main(String[] args) {
		...
		Collections.sort(courseList, new CourseSortByNameAsc());
		System.out.println("\nSorted by Name:");
		for (Course course : courseList) {
			System.out.println(course);
		}

		Collections.sort(courseList, new CourseSortByCreditAsc());
		System.out.println("\nSorted by Credit:");
		for (Course course : courseList) {
			System.out.println(course);
		}

		Collections.sort(courseList, new CourseSortByDepartmentAsc());
		System.out.println("\nSorted by Department:");
		for (Course course : courseList) {
			System.out.println(course);
		}

		Collections.sort(courseList, new CourseSortBySemesterAsc());
		System.out.println("\nSorted by Semester:");
		for (Course course : courseList) {
			System.out.println(course);
		}
		...
		try {
			...
			// Update student
			Student updatedStudent = new Student(6, "John Smith", "13-12-1968", "john.smith@gmail.com", "0834444444",
					"Thai Nguyen", "S006", 3.0);
