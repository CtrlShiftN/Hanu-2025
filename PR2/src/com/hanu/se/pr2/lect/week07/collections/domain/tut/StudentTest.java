...
public class StudentTest {
	public static void main(String[] args) {
		...
		try {
			studentList.add(
					new Student(1, "Le Nam", "13-02-2005", "lenam@example.com", "0912345678", "Hanoi", "S001", 3.5));
			studentList.add(new Student(2, "Nam", "11-02-2005", "nam@example.com", "0987654321", "HCM", "S002", 3.8));
			studentList
					.add(new Student(3, "Lan", "12-02-2006", "lan@example.com", "0855555555", "Danang", "S003", 2.9));
		...
		System.out.println("\nTesting Invalid Cases:");
		String[][] testCases = {
				{ "0", "John Doe", "12-05-1990", "johndoe@example.com", "0912345678", "Hanoi", "", "3.5" }, // Empty
																											// student
																											// ID
				{ "1", "", "12-05-1990", "johndoe@example.com", "0912345678", "Hanoi", "S007", "3.2" }, // Empty name
				{ "2", "John123", "12-05-1990", "johndoe@example.com", "0912345678", "Hanoi", "S008", "2.8" }, // Name
																												// with
																												// digits
				{ "3", "John Doe", "1990-05-12", "johndoe@example.com", "0912345678", "Hanoi", "S009", "3.0" }, // Wrong
																												// date
																												// format
				{ "4", "John Doe", "12-05-2090", "johndoe@example.com", "0912345678", "Hanoi", "S010", "3.1" }, // Future
																												// date
				{ "5", "John Doe", "12-05-1990", "invalidEmail", "0912345678", "Hanoi", "S011", "2.5" }, // Invalid
																											// email
				{ "6", "John Doe", "12-05-1990", "johndoe@example.com", "+84123abc456", "Hanoi", "S012", "2.0" }, // Invalid
																													// phone
				{ "7", "John Doe", "12-05-1990", "johndoe@example.com", "0912345678", "", "S013", "3.3" }, // Empty
																											// address
				{ "8", "John Doe", "12-05-1990", "johndoe@example.com", "0912345678", "Hanoi", "S014", "4.5" } // Invalid
																												// GPA
																												// out
																												// of
																												// range
		...
		Collections.sort(studentList, new StudentSortByGPADesc());

		// Display list after sorting
		System.out.println("\nAfter Sorting by GPA (desccending):");
		for (Student student : studentList) {
			System.out.println(student);
		}
	}
